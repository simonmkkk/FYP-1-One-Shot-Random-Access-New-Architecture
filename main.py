...
def run_pipeline_figure1():
    ...
    print(f"\n{'='*60}")
    print(f"Figure 1 完整流程完成! 耗時: {elapsed:.2f}秒")
    print(f"{'='*60}")
...
def run_pipeline_figure2():
    ...
    elapsed = time.time() - start_time
    print(f"\n{'='*60}")
    print(f"Figure 2 完整流程完成! 耗時: {elapsed:.2f}秒")
    print(f"{'='*60}")
...
def run_pipeline_figure345():
    ...
    elapsed = time.time() - start_time
    print(f"\n{'='*60}")
    print(f"Figure 3, 4, 5 完整流程完成! 耗時: {elapsed:.2f}秒")
    print(f"{'='*60}")
...
def run_pipeline_all():
    ...
    elapsed = time.time() - start_time
    print(f"\n{'='*60}")
    print(f"所有完整流程完成! 總耗時: {elapsed:.2f}秒")
    print(f"{'='*60}")
